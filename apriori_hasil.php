        ...
        <div class="panel panel-primary">
            ...
            <div class="table-responsive collapse" id="L_<?= $itemset ?>">
                <table class="table table-bordered table-striped">
                    ...
                    $no = 1;
                    arsort($support);
                    foreach ($support as $key => $val) : if ($val * 100 < $min_support) continue ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <?php foreach ($com_category[$key] as $k) : ?>
                                <td><?= $k ?></td>
...
endwhile; ?>
<a class="btn btn-default" href="cetak.php?m=apriori" target="_blank"><span class="glyphicon glyphicon-print">
</span> Cetak</a> <br><br>
<?php
